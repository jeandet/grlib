This LEON design is tailored to the Digilent Arty board
---------------------------------------------------------
...
Example GRMON3 session:


-bash-4.1$ grmon -uart /dev/ttyUSB1

  GRMON LEON debug monitor v3.0.2 64-bit eval version

  Copyright (C) 2018 Cobham Gaisler - All rights reserved.
  For latest updates, go to http://www.gaisler.com/
  Comments or bug-reports to support@gaisler.com

  This eval version will expire on 21/09/2018
...
grmon3> load a.out
  40000000 .text                     62.5kB /  62.5kB   [===============>] 100%
  4000FA10 .rodata                    1.6kB /   1.6kB   [===============>] 100%
  40010090 .data                      1.5kB /   1.5kB   [===============>] 100%
  Total size: 65.65kB (103.78kbit/s)
  Entry point 0x40000000
  Image /home/jeandet/Téléchargements/grmon-eval-64-3.0.2/grmon-eval-3.0.2/linux/a.out loaded

grmon3> verify a.out
  40000000 .text                     62.5kB /  62.5kB   [===============>] 100%
  4000FA10 .rodata                    1.6kB /   1.6kB   [===============>] 100%
  40010090 .data                      1.5kB /   1.5kB   [===============>] 100%
  Total size: 65.65kB (63.87kbit/s)
  Entry point 0x40000000
  Image of /home/jeandet/Téléchargements/grmon-eval-64-3.0.2/grmon-eval-3.0.2/linux/a.out verified without errors
