...
set_property -dict { PACKAGE_PIN C2  IOSTANDARD LVCMOS33 } [get_ports { cpu_resetn }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn
...
#set_property -dict { PACKAGE_PIN E9    IOSTANDARD LVCMOS33 } [get_ports { scl }];
